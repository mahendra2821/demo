...
<div className="md:grid lg:grid lg:grid-cols-2 md:grid-cols-2 ml-[10vw] mr-5 font-serif">
    <div className="md:flex lg:flex ml-[10vw] font-serif grid lg:grid-cols-2 md:grid-cols-2 mr-2 lg:hidden-none md:hidden-none ">
        <img src="https://img.freepik.com/premium-photo/green-pair-shoes-watch-wooden-table_1161029-9150.jpg?w=900" className="lg:h-[45vh] lg:ml-[5vw] md:h-[45vh] md:ml-[1vw] mt-2" /> 

{/* <div className="hidden md:grid lg:grid lg:grid-cols-2 md:grid-cols-2 ml-[10vw] mr-5 font-serif">
  <img
    src="https://img.freepik.com/premium-photo/green-pair-shoes-watch-wooden-table_1161029-9150.jpg?w=900"
    className="lg:h-[45vh] lg:ml-[15vw] md:h-[45vh] md:ml-[2vw] mt-5"
    alt="Green Shoes and Watch"
  /> */}
        <div  className="border-2 bg-zinc-200 lg:mt-[9px] md:mt-[9px] md:w-[45vw] lg:w-[25vw] ">
            <p  className="lg:ml-[2vw] md:ml-[5vh] md:mr-[20vw] ml-5  mt-5 lg:mt-2 font-serif font-bold  ">Limmited </p>
            <h1 className="lg:ml-[2vw] md:ml-[5vh] ml-5 text-[15px] font-serif font-bold text-emerald-900 lg:w-[15vw] md:w-[20vw] mr-5"> 35% off only this friday and get Special gift. </h1> 
            <div className="flex">
            <button className="lg:ml-[2vw] md:text-[15px] md:ml-[4vh] ml-5 mb-5 bg-white text-black font-serif hover:font-bold py-2 px-4 rounde mt-4 rounded hover:text-white transition-colors duration-300"> Book Now →</button> 
